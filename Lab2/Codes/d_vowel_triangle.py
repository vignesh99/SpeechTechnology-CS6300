...
aaf1 = []
aaf2 = []
with open("d_aa_1.csv") as csvfile:
...
eef1 = []
eef2 = []
with open("d_ee_1.csv") as csvfile:
    reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC) # change contents to floats
    for row in reader: # each row is a list
        eef1.append(row[:1])
        eef2.append(row[1:2])
...
uuf1 = []
uuf2 = []
with open("d_uu_1.csv") as csvfile:
    reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC) # change contents to floats
    for row in reader: # each row is a list
        uuf1.append(row[:1])
        uuf2.append(row[1:2])
...
aef1 = []
aef2 = []
with open("d_ae_1.csv") as csvfile:
    reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC) # change contents to floats
    for row in reader: # each row is a list
        aef1.append(row[:1])
        aef2.append(row[1:2])
...
oof1 = []
oof2 = []
with open("d_oo_1.csv") as csvfile:
    reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC) # change contents to floats
    for row in reader: # each row is a list
        oof1.append(row[:1])
        oof2.append(row[1:2])
